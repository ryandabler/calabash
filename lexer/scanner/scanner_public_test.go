...
func TestRead(t *testing.T) {
	...
	*/
	table := []struct {
		...
		{name: "number", text: "123", expected: []tokens.Token{tokens.New(tokentype.NUMBER, "123", 0, 0)}},
		{name: "number", text: "123.5", expected: []tokens.Token{tokens.New(tokentype.NUMBER, "123.5", 0, 0)}},
