		...
		table := []struct {
		...
		}{
			{
				...
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VString{Value: "abcd"}) {
			...
			},
			{
				...
				text: "123",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: 123}) {
			...
			},
			{
				...
				text: "123.4",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: 123.4}) {
			...
			},
			{
				...
				text: "bottom",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VBottom{}) {
			...
			},
			{
				...
				text: "1 + 1",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: 2}) {
			...
			},
			{
				...
				text: "'1' + '1'",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VString{Value: "11"}) {
			...
			},
			{
				...
				text: "2 * 5",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: 10}) {
			...
			},
			{
				...
				text: "5 / 3",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: 5.0 / 3.0}) {
			...
			},
			{
				...
				text: "5 ** 2",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: 25}) {
			...
			},
			{
				...
				text: "-5",
				validate: func(v interface{}, _ interpreter.IntpState) error {
					if !reflect.DeepEqual(v, value.VNumber{Value: -5}) {
			...
			},
			{
				...
				validate: func(v interface{}, i interpreter.IntpState) error {
					...
					if i.Env.Get("a") != (value.VBottom{}) && i.Env.Get("b") != (value.VBottom{}) {
						return errors.New("Undefined variables should be initialized with bottom value")
					}
			...
			},
			{
				...
				validate: func(_ interface{}, i interpreter.IntpState) error {
					if i.Env.Get("a") != (value.VNumber{Value: 1}) {
						return errors.New("Variable 'a' was not set to value 1")
					}

					if i.Env.Get("b") != (value.VNumber{Value: 7}) {
			...
			},
			{
				...
				validate: func(v interface{}, i interpreter.IntpState) error {
					...
					if !reflect.DeepEqual(fn.Apps, []value.Value{value.VNumber{Value: 1}}) {
			...
			// },
			{
				...
				validate: func(v interface{}, i interpreter.IntpState) error {
					if !reflect.DeepEqual(i.Env.Get("a"), value.VBottom{}) {
						return errors.New("Function parameters should be declared in an inner scope")
					}

					if !reflect.DeepEqual(i.Env.Get("b"), value.VBottom{}) {
			...
			},
			{
				...
				text: "let mut a; a = 4;",
				validate: func(_ interface{}, i interpreter.IntpState) error {
					if i.Env.Get("a") != (value.VNumber{Value: 4}) {
			...
			},
			{
				...
				validate: func(_ interface{}, i interpreter.IntpState) error {
					if i.Env.Get("b") != (value.VNumber{Value: 2}) {
			...
			},
			{
				...
				validate: func(_ interface{}, i interpreter.IntpState) error {
					if i.Env.Get("b") != (value.VNumber{Value: 3}) {
